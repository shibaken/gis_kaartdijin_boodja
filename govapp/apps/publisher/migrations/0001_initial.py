    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField()),
                ('description', models.TextField()),
                ('mode', models.IntegerField(choices=[(1, 'Wms'), (2, 'Wms And Wfs')])),
                ...
                ('workspace', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='publish_channels', to='publisher.workspace')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField()),
                ('description', models.TextField()),
                ('mode', models.IntegerField(choices=[(1, 'Azure'), (2, 'Azure And Sharepoint')])),
                ('frequency', models.IntegerField(choices=[(1, 'On Change')])),
