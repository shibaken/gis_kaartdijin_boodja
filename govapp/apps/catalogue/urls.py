...
router.register("layers/submissions2", views.LayerSubmissionDatatableViewSet, basename='layersubmission2')
...
router.register("permission", views.CatalogueEntryPermissionViewSet)
